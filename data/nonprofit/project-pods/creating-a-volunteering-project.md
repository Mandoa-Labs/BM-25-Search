...
* Your nonprofit is a verified member of **GitHub for Nonprofits**. If you haven't joined yet, see [Quickstart for GitHub for Nonprofits](/en/nonprofit/quickstart) to apply.
...
3. If you haven't joined yet, see [Quickstart for GitHub for Nonprofits](/en/nonprofit/quickstart) to apply.
