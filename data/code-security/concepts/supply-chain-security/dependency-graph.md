...
* View and update vulnerable dependencies for your repository. For more information, see [Dependabot alerts](/en/code-security/dependabot/dependabot-alerts/about-dependabot-alerts).
