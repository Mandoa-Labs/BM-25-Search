...
For information on the usage, scope, permissions, and limitations of each secret type, see [Understanding GitHub secret types](/en/code-security/reference/secret-security/understanding-github-secret-types).