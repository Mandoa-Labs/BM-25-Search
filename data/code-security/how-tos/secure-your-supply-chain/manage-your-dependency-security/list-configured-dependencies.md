...
For information about Dependabot job logs, see [Viewing Dependabot job logs](/en/code-security/dependabot/troubleshooting-dependabot/viewing-dependabot-job-logs).