...
If you plan to use the CodeQL CLI for security research or to test or contribute queries, you may need a more advanced setup. For more information, see [CodeQL CLI](/en/code-security/concepts/code-scanning/codeql/about-the-codeql-cli#getting-started).
