...
Use Governor to identify Git traffic patterns that are driving load on your instance, so you can troubleshoot slow Git operations and reduce performance impact.
...
Governor records Git operations only. It does not include API or web traffic. To inspect operations currently running, see the `ghe-btop` utility in [Command-line utilities](/en/enterprise-server@3.21/admin/administering-your-instance/administering-your-instance-from-the-command-line/command-line-utilities#ghe-btop).
...
* **SSH access to the appliance.** You need access to the administrative shell to run `ghe-governor`. See [Accessing the administrative shell (SSH)](/en/enterprise-server@3.21/admin/administering-your-instance/administering-your-instance-from-the-command-line/accessing-the-administrative-shell-ssh).
...
For more information about generating a support bundle, see [Providing data to GitHub Support](/en/enterprise-server@3.21/support/contacting-github-support/providing-data-to-github-support#creating-and-sharing-support-bundles).

## Further reading

For more information about monitoring system resources, see [About the monitor dashboards](/en/enterprise-server@3.21/admin/monitoring-and-managing-your-instance/monitoring-your-instance/about-the-monitor-dashboards).