...
Build a repeatable workflow for Copilot code review from draft pull request to merge.
...
2. Request a review from Copilot code review under **Reviewers**, or enable automatic review for draft pull requests.
3. Address high-confidence feedback first, such as correctness, security, and clear maintainability issues.
4. Push updates and confirm that major comments have been resolved.
5. Mark the pull request as ready for human review.
...
For detailed customization mechanics and examples, see [Using custom instructions to unlock the power of Copilot code review](/en/copilot/tutorials/customize-code-review).
...
For setup details, see [Adding agent skills for GitHub Copilot](/en/copilot/how-tos/copilot-on-github/customize-copilot/customize-cloud-agent/add-skills) and [Configure MCP servers for your repository](/en/copilot/how-tos/copilot-on-github/customize-copilot/configure-mcp-servers).
...
For planning and setup details, see [Configuring runners for GitHub Copilot code review](/en/copilot/how-tos/copilot-on-github/set-up-copilot/configure-runners).
...
* For broader concepts, including review effort and agentic capabilities, see [About GitHub Copilot code review](/en/copilot/concepts/agents/code-review).
* To tune automated review quality for specific repositories, see [Build an optimized review process with Copilot](/en/copilot/tutorials/optimize-code-reviews).
* For excluded file types and other limits, see [Files excluded from GitHub Copilot code review](/en/copilot/reference/review-excluded-files).