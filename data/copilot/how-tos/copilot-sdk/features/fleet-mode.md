...
For hook configuration that is already exposed at the SDK layer, see [Working with hooks](/en/copilot/how-tos/copilot-sdk/features/hooks). For sub-agent event payloads, see [Custom agents and sub-agent orchestration](/en/copilot/how-tos/copilot-sdk/features/custom-agents).
