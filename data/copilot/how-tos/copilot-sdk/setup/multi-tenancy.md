...
This guide is a sister to [Scaling and multi-tenancy](/en/copilot/how-tos/copilot-sdk/setup/scaling). Use that guide for topology, load-balancing, and storage patterns. Use this guide for SDK-level options and runtime isolation choices.
...
| ------------------------------------------ | ---------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| Pattern 1: isolated CLI per user           | You need the strongest isolation boundary or separate process credentials per user.            | Strong isolation; higher resource cost. See [Scaling and multi-tenancy](/en/copilot/how-tos/copilot-sdk/setup/scaling).                 |
...
| Pattern 3: hybrid                          | You route compute-heavy work to cloud sessions and light work to local sessions.               | Flexible; requires workload routing and policy handling. See [Cloud sessions](/en/copilot/how-tos/copilot-sdk/features/cloud-sessions). |
...
* [Scaling and multi-tenancy](/en/copilot/how-tos/copilot-sdk/setup/scaling): deployment topologies, storage patterns, and isolation comparisons
* [Backend services setup](/en/copilot/how-tos/copilot-sdk/setup/backend-services): running the runtime in headless server mode
* [BYOK (bring your own key)](/en/copilot/how-tos/copilot-sdk/auth/byok): using your own model provider credentials
* [Cloud sessions](/en/copilot/how-tos/copilot-sdk/features/cloud-sessions): routing selected work to cloud sessions
* [Session resume and persistence](/en/copilot/how-tos/copilot-sdk/features/session-persistence): managing resumable session state
* [Features](/en/copilot/how-tos/copilot-sdk/features): tools, events, hooks, and advanced SDK features