...
For more information about the available settings, see [GitHub Copilot CLI configuration directory](/en/copilot/reference/copilot-cli-reference/cli-config-dir-reference#user-settings-copilotsettingsjson).
...
2. Use the <kbd>↓</kbd> key to move down the list until `❯` points to `/settings askUser  Allow the agent to ask clarifying questions`, then press <kbd>Enter</kbd>.
3. Use the <kbd>↓</kbd> key to move down the list of options for this setting until `❯` points to `/settings askUser off`, then press <kbd>Enter</kbd>.
4. Press <kbd>Enter</kbd> again to submit the `/settings askUser off` command.
...
For the full list of available settings and how user, repository, and organization settings combine, see [GitHub Copilot CLI configuration directory](/en/copilot/reference/copilot-cli-reference/cli-config-dir-reference).
