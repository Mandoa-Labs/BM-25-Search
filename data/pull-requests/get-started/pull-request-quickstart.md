...
1. To use GitHub CLI, you'll need to install it first. See [GitHub CLI quickstart](/en/github-cli/github-cli/quickstart).
...
After your first pull request, try reviewing someone else's work. See [Quickstart for reviewing pull requests](/en/pull-requests/get-started/reviewing-pull-requests-quickstart).
